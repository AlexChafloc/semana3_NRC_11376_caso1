...
public class V1 extends JFrame implements ActionListener {
	...
	public V1() {
		...
		contentPane.setLayout(null);
		{
			...
			lblNewLabel.setBounds(21, 26, 105, 14);
			contentPane.add(lblNewLabel);
		}
		{
			lblSegundoNmero = new JLabel("Segundo número");
			lblSegundoNmero.setBounds(21, 59, 117, 14);
			contentPane.add(lblSegundoNmero);
		}
		{
			lblTercerNmero = new JLabel("Tercer número");
			lblTercerNmero.setBounds(21, 95, 105, 14);
			contentPane.add(lblTercerNmero);
		}
		{
			txtNum1 = new JTextField();
			txtNum1.setBounds(124, 23, 86, 20);
			contentPane.add(txtNum1);
			txtNum1.setColumns(10);
		}
		{
			txtNum2 = new JTextField();
			txtNum2.setBounds(124, 56, 86, 20);
			contentPane.add(txtNum2);
			txtNum2.setColumns(10);
		}
		{
			txtNum3 = new JTextField();
			txtNum3.setBounds(124, 92, 86, 20);
		...
		}
		{
			...
			btnSumarDosReales.setBounds(237, 91, 167, 23);
			contentPane.add(btnSumarDosReales);
		}
		{
			scrollPane = new JScrollPane();
			scrollPane.setBounds(21, 129, 386, 110);
	...
	protected void do_btnSumarTresEnteros_actionPerformed(ActionEvent e) {
		...
		int n1 = Integer.parseInt(txtNum1.getText());
		 ...
		 Calculadora c = new Calculadora(n1, n2, n3);
			txtS.append("\n La suma de los tres enteros es : " +c.Sumar(n1, n2,n3));
		} catch (Exception e2) {
			 MostrarError();
		}	
	}
	...
	try {
		...
		txtS.append("\nLa suma de los reales es: " +c.Sumar(num1, num2));
	} catch (Exception e2) {
		MostrarError();
	}		
	}
